...
const unsigned char hz_yuan PROGMEM[] = 
{
0x00,0x00,0x3F,0xFE,0x20,0x80,0x21,0x00,0x27,0xF0,0x24,0x10,0x24,0x10,0x27,0xF0,
0x24,0x10,0x24,0x10,0x27,0xF0,0x20,0x80,0x24,0x90,0x48,0x88,0x52,0x84,0x81,0x00/*"原",1*/
};

const unsigned char hz_hang PROGMEM[] = 
{
...
const unsigned char hz_州 PROGMEM[] = 
{
...
const unsigned char hz_dian PROGMEM[] =
{
...
const unsigned char hz_shi PROGMEM[] =
{
	...
	0x55,0x24,0x95,0x54,0x10,0x50,0x10,0x90,0x10,0x90,0x11,0x12,0x12,0x12,0x14,0x0E/*"视",2*/
};

const unsigned char hz_lun PROGMEM[] =
{0x11,0x00,0x13,0x00,0x22,0x80,0x24,0x40,0x6A,0x20,0xF2,0x40,0x23,0x80,0x22,0x00,
0x22,0x00,0x22,0x20,0x23,0xE0,0x00,0x00/*"伦",0*/
};
...
{
  {"周", hz_zhou,16}, {"一", hz_Mon,16}, {"二", hz_Tue,16}, {"三", hz_Wed,16}, {"四", hz_Thu,16},{"五", hz_Fri,16}, {"六", hz_Sat,16}, {"日", hz_Sunday,16}, 
	{"晴", hz_sun,16}, {"阴", hz_cloudy,16}, {"雨", hz_rain,16}, {"雪", hz_snow,16}, {"多", hz_duo,16}, {"云", hz_yun,16},
	{"太", hz_tai,16},{"原", hz_yuan,16},{"杭", hz_hang,16},{"州", hz_州,16},
  {"东", hz_dong,16}, {"西", hz_xi,16}, {"南", hz_nan,16}, {"北",hz_bei,16}, {"风", hz_feng, 16},
  {"关", hz_guan,16}, {"注", hz_zhu,16}, {"粉", hz_fen,16}, {"丝",hz_si,16}, {"数", hz_shu,16},{"小",hz_xiao,16}, {"电", hz_dian,16}, {"视", hz_shi,16}
};
